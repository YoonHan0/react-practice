...
ReactModal.setAppElement('body');   // body로 해야 모달창이 전체(body)에서 움직일 수 있다.
...
export default function App() {
    ...
    return (
        <Fragment>
            ...
            {/* 모달창을 useState로 만들어두고 true, false를 변경하면서 창을 띄우고 제거하는 방식으로 사용한다. */}
            ...
            <Modal
                ...
                onRequestClose={ () => setModal02IsOpen(false) }    /* 모달창 밖을 클릭하면 제거 */
