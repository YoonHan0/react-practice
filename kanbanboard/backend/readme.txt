	...
	2. ssh 연결(ssh key 인증)
		...
		5) ssh 연결 환경 설정
			...
			/root/.local/bin:/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/usr/local/douzone2023/java/bin:/usr/local/douzone2023/git/bin:/usr/local/douzone2023/maven3.8/bin
			======================
